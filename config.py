...
BOT_TOKEN = getenv("BOT_TOKEN", "7082508513:AAGZVIGeE6griITWx011MehC-CzbNkVWkkM")
MONGO_DB_URI = getenv("MONGO_DB_URI", "mongodb+srv://levoz:<password>@cluster0.t5621cf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 500))
LOGGER_ID = int(getenv("LOGGER_ID", "-1001595674917"))
OWNER_ID = int(getenv("OWNER_ID", 5805605739))
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Kurucu0/Pi",
)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Holigras")
